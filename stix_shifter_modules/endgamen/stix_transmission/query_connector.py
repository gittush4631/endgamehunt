    ...
    async def create_query_connection(self, query):
        ...
        try:
            ...
            if 'oper' in response:
                ...
                print("OPERATION IS SEARCHING ALERTS or CHATAPI")
                ...
                if(key=='timestamp'):
                    ...
                    print("========================INSIDE CHAT API RAW TEXT QUERY DEFINITION======================")
                    return_obj['search_id'] = key+"="+response[key]+'="chat"'               
                    print("==========return obj for  FINAL CHAT API QUERY======================")
                    print(return_obj)
